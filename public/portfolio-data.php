...
return [
    ...
    'projects' => [
        [
            'featured' => true,
            'title' => 'Find Best Firms (FBF)',
            'tagline' => 'Helping businesses discover and connect with the best IT service providers worldwide.',
            'description' => 'A B2B marketplace platform that enables businesses to discover, compare, and connect with top-rated IT companies across different technologies and industries. Features company profiles, reviews, ratings, blogs, and advanced search.',
            'url' => 'https://findbestfirms.com/',
            'github' => '#',
            'casestudy' => '#',
            'live' => true,
            ...
            'period' => '2025 – 2026',
            'stats' => [
                ['value' => '15+', 'label' => 'Modules Built', 'icon' => 'fas fa-cubes'],
                ['value' => '50+', 'label' => 'API Endpoints', 'icon' => 'fas fa-plug'],
                ['value' => '10+', 'label' => 'DB Tables', 'icon' => 'fas fa-database'],
                ['value' => '100%', 'label' => 'API Coverage', 'icon' => 'fas fa-shield-alt'],
            ],
            'features' => [
                'Company Listings & Profiles', 'Ratings & Reviews',
                'Vendor Dashboard', 'Admin Dashboard',
                'User Authentication', 'Subscription Plans',
                'Blog & SEO Management', 'Search & Advanced Filters',
                'REST APIs', 'Role Based Access Control (RBAC)',
            ],
            'technologies' => ['Laravel', 'PHP', 'MySQL', 'JavaScript', 'HTML', 'CSS', 'Bootstrap', 'REST API', 'Git', 'Repository Pattern', 'SOLID Principles'],
            'icon' => 'fas fa-building',
            'color' => '#6C63FF',
        ],
        [
            'title' => 'My Portfolio Website',
            'description' => 'A fully responsive portfolio website built with AI avatar, voice TTS, and premium animations.',
            'features' => ['AI Avatar', 'Voice TTS', 'Interactive UI', 'Responsive Design', 'Premium Animations'],
            'icon' => 'fas fa-globe',
            'color' => '#6C63FF',
        ],
        [
            'title' => 'Smart Canteen System',
            'description' => 'A web-based canteen management system developed using PHP, MySQL, JavaScript.',
            'features' => ['User Authentication', 'Online Food Ordering', 'Order History', 'Receipt Generation', 'OTP Verification'],
            'icon' => 'fas fa-utensils',
            'color' => '#00C9A7',
        ],
        [
            'title' => 'Saint Umar Academy Website',
            'description' => 'Educational institution website with focus on usability and user experience.',
            'features' => ['Gallery Section', 'Classroom Info', 'Laboratory Info', 'Responsive Layout', 'Easy Navigation'],
            'icon' => 'fas fa-school',
            'color' => '#FF6B6B',
        ],
        [
            'title' => 'Object Detection Fine-Tuning',
            'description' => 'ML project focused on improving object detection accuracy using Python.',
            'features' => ['Real-Time Detection', 'Model Fine-Tuning', 'Improved Accuracy', 'Custom Detection'],
            'icon' => 'fas fa-robot',
            'color' => '#FFA726',
        ],
    ],
